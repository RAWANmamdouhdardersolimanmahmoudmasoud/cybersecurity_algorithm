...
from crpto.ciphers import RSAC, affineC, vernamOneTimePadC, caesarC, homophonicC, railfenceC, autokeyC, atbashC, columnerC, \
...
def cipher():
    ...
    main = Frame(window, width=800, height=400, relief=SUNKEN, bg='khaki')
    main.pack()

    time_frame = Frame(window, width=500, height=30, relief=SUNKEN, background='white')
    ...
    def lab():
        text_label = Label(main, text="Enter text: ", font=('fixedsys', 16, "bold"), bg="khaki", fg="black")
        ...
        key_label = Label(main, text="Enter key: ", font=('fixedsys', 14), pady=15, bg='khaki', fg="black")
        ...
        upload_button = Button(main, text="Upload", command=upload_file)
        upload_button.grid(row=5, column=2, pady=10)

        download_button = Button(main, text="Download", command=download_file)
    ...
    def caesar_cipher():  # 1st cipher
        ...
        enc = Button(main, text="Encrypt", bd=10, width=10, command=encrypt, bg='goldenrod', fg='white')
        ...
        dec = Button(main, text="Decrypt", bd=10, width=10, command=decrypt, bg='goldenrod', fg='white')
    ...
    def homophonic_cipher():
        ...
        text_label = Label(main, text="Enter text: ", font=('fixedsys', 14, 'bold'), bg='khaki', fg="black")
        text_label.grid(row=0, column=0, padx=20, pady=20)

        scroll_text = ttk.Scrollbar(main, orient=VERTICAL)
        label = Label(main, text="homophonic_cipher")
        label.grid(row=0, column=1)
        text_box = Text(main, height=15, width=40, pady=10, yscrollcommand=scroll_text.set, bg='white')
        text_box.grid(row=1, column=0, pady=1, padx=1)
        scroll_text.config(command=text_box.yview)
        scroll_text.grid(row=1, column=1, sticky='NS')

        scroll_text2 = ttk.Scrollbar(main, orient=VERTICAL)
        new_text = Text(main, height=15, width=40, pady=10, yscrollcommand=scroll_text2.set, bg='white')
        new_text.grid(row=1, column=2, columnspan=2, padx=(10, 0))
        sample = "Sample text input:\nAny character\n"
        new_text.insert(1.0, sample)
    ...
    def atbash_cipher():
        ...
        label.grid(row=0, column=1)
        text_box = Text(main, height=20, width=40, pady=10, yscrollcommand=scroll_text.set, bg='white')
        text_box.grid(row=1, column=0, pady=1, padx=1)
        scroll_text.config(command=text_box.yview)
        scroll_text.grid(row=1, column=1, sticky='NS')

        scroll_text2 = ttk.Scrollbar(main, orient=VERTICAL)
        new_text = Text(main, height=20, width=40, pady=10, yscrollcommand=scroll_text2.set, bg='white')
        new_text.grid(row=1, column=2, columnspan=2, padx=(10, 0))
        scroll_text2.config(command=new_text.yview)
        scroll_text2.grid(row=1, column=4, sticky='NS')
        sample = "Sample text input:\nAny character\n"
    ...
    def onetimepad():
        ...
        sample = "Sample text input:\nAny character\n\nInput Type\n for alphabets 1\n for binary 2 \n for numbers 3"
        new_text.insert(1.0, sample)
        text_label = Label(main, text="Input Type: ", font=('fixedsys', 14, 'bold'), bg='khaki', fg="black")
    ...
    home_button = Button(left_frame, padx=20, bd=10, text='Home', width=20, height=2, command=window_show,
                         bg='goldenrod', fg='white', activebackground='black', font=('arial', 12, 'bold'),
                         activeforeground='SeaGreen1')
    home_button.grid(row=0, column=0)

    caesar = Button(left_frame, padx=20, bd=10, text='Caesar Cipher', width=20, height=2, command=caesar_cipher,
                    bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                    activeforeground='SeaGreen1')
    caesar.grid(row=1, column=0)

    homophonic = Button(left_frame, padx=20, bd=10, text='Homophonic Cipher', width=20, height=2,
                        command=homophonic_cipher, bg='white', fg='black', activebackground='black',
                        font=('arial', 12, 'bold'), activeforeground='SeaGreen1')
    homophonic.grid(row=2, column=0)

    vignere = Button(left_frame, padx=20, bd=10, text='Vignere Cipher', width=20, height=2, command=vignere_cipher,
                     bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                     activeforeground='SeaGreen1')
    vignere.grid(row=3, column=0)

    autokey = Button(left_frame, padx=20, bd=10, text='Autokey Cipher', width=20, height=2, command=autokey_cipher,
                     bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                     activeforeground='SeaGreen1')
    autokey.grid(row=4, column=0)

    railfence = Button(left_frame, padx=20, bd=10, text='Railfence Cipher', width=20, height=2,
                       command=railfence_cipher, bg='white', fg='black', activebackground='black',
                       font=('arial', 12, 'bold'), activeforeground='SeaGreen1')
    railfence.grid(row=5, column=0)

    affine = Button(left_frame, padx=20, bd=10, text='Affine Cipher', width=20, height=2, command=affine_cipher,
                    bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                    activeforeground='SeaGreen1')
    affine.grid(row=7, column=0)

    onetimepad = Button(left_frame, padx=20, bd=10, text='One Time Pad', width=20, height=2, command=onetimepad,
                        bg='white', fg='black', font=('arial', 12, 'bold'), activebackground='black',
                        activeforeground='SeaGreen1')
    onetimepad.grid(row=8, column=0)

    playfair = Button(right_frame, padx=20, bd=10, text='Playfair Cipher', width=20, height=2, command=playfair_cipher,
                      bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                      activeforeground='SeaGreen1')
    playfair.grid(row=6, column=0)

    atbash = Button(right_frame, padx=20, bd=10, text='Atbash Cipher', width=20, height=2, command=atbash_cipher,
                    bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                    activeforeground='SeaGreen1')
    atbash.grid(row=9, column=0)

    vignere_autokey = Button(right_frame, padx=20, bd=10, text='Vignere Autokey Cipher', width=20, height=2,
                             command=vignere_autokey_cipher, bg='white', fg='black', font=('arial', 12, 'bold'),
                             activebackground='black', activeforeground='yellow')
    vignere_autokey.grid(row=10, column=0)

    beaufort = Button(right_frame, padx=20, bd=10, text='Beaufort Cipher', width=20, height=2, command=beaufort_cipher,
                      bg='white', fg='black', activebackground='black', font=('arial', 12, 'bold'),
                      activeforeground='SeaGreen1')
    beaufort.grid(row=11, column=0)

    beaufort_autokey = Button(right_frame, padx=20, bd=10, text='Beaufort Autokey Cipher', width=20, height=2,
                              command=beaufort_autokey_cipher, bg='white', fg='black', font=('arial', 12, 'bold'),
                              activebackground='black', activeforeground='SeaGreen1')
    beaufort_autokey.grid(row=12, column=0)

    columnar = Button(right_frame, padx=20, bd=10, text='Columnar Transposition Cipher', width=20, height=2,
                      command=columnar_trans_cipher, bg='white', fg='black', font=('arial', 12, 'bold'),
                      activebackground='black', activeforeground='SeaGreen1')
    columnar.grid(row=13, column=0)

    morse = Button(right_frame, padx=20, bd=10, text='Morse Code', width=20, height=2, command=morse_code, bg='white',
                   fg='black', font=('arial', 12, 'bold'), activebackground='black', activeforeground='SeaGreen1')
    morse.grid(row=14, column=0)
    Exit = Button(right_frame, text="Exit", bd=10, width=10, command=window.destroy, activebackground="black",
                  bg='goldenrod', fg="white", font=('arial', 12, 'bold'), activeforeground="green2")
...
def hackertools():
    ...
    def window_show():
        remove()
        downLabel = "Cryptography, or cryptology, is the practice and study of techniques for secure communication in the presence of third parties called adversaries."
...
Welcome_label = Label(root, text="Welcome to Cryptography ciphers", padx=15, pady=35, bg="gold", fg="black",
                      font=("Helvetica", 20, "bold")).pack(pady=30)
chiper_button = Button(root, text="Cryprocypher", padx=20, bd=10, width=20, height=3, command=cipher, bg="khaki",
                       fg="dark red", activebackground='black', activeforeground='SeaGreen1')
chiper_button.pack(pady=30)
hacker_button = Button(root, text="Bouns", padx=20, bd=10, width=20, height=3, command=hackertools,
                       bg="khaki", fg="dark red", activebackground='black', activeforeground='SeaGreen1')
